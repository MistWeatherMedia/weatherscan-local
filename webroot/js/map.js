...
function convertGeoToPixel(
  ...
  console.log(locationConfig.mainCity.lat)
...
function centerBaseMap(lat, lon) {
  ...
  console.log("PLEASE END MY PAINNNN: ");
  console.log(xy);
...
function mapPrintLoc() {
  console.log("Left: " + xlMapLeft);
  console.log("Right: " + xlMapRight);
  console.log("Bottom: " + xlMapBottom);
  console.log(
    "Make sure to correctly set xlMapLeft, xlMapRight, and xlMapBottom respectively!"
  );
}
