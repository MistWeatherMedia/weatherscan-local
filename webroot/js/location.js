...
function locationJS() {
  ...
  function locationGrab() {
    if (locationSettings.mainCity.autoFind == false) {
      if (locationSettings.mainCity.type == "postalKey") {
        if (
          !locationSettings.mainCity.val.includes(":US") &&
          locationSettings.mainCity.val.toString().length >= 5
        ) {
      ...
      $.getJSON(
        ...
        function (data) {
          locationConfig.mainCity.displayname =
            locationSettings.mainCity.displayname != ""
              ? locationSettings.mainCity.displayname
      ...
      if (window.location.search) {
        $.getJSON(
          "https://api.weather.com/v3/location/search?query=" +
            queryname +
            "&language=en-US&format=json&apiKey=" +
            api_key,
          function (data) {
          ...
          $.getJSON(
            "https://pro.ip-api.com/json/?key=AmUN9xAaQALVYu6&exposeDate=false",
            function (data) {
  ...
  function manualExtraLoc() {
    if (locationSettings.extraCity.type == "postalKey") {
      if (
        !locationSettings.extraCity.val.includes(":US") &&
        locationSettings.mainCity.val.toString().length >= 5
      ) {
    ...
    $.getJSON(
      ...
      function (data) {
        locationConfig.extraCity.displayname =
          locationSettings.extraCity.displayname != ""
            ? locationSettings.extraCity.displayname
            : data.location.displayName;
  ...
  function autoExtraLoc() {
    $.getJSON(
      "https://api.weather.com/v3/location/near?geocode=" +
        ...
        "," +
        locationConfig.mainCity.lon +
        "&product=observation&format=json&apiKey=" +
        api_key,
      function (data) {
  ...
  function autoSurroundingLocs() {
    $.getJSON(
      ...
      function (data) {
        ...
        setTimeout(() => {
          locationConfig.eightCities.citiesAmount =
            locationConfig.eightCities.cities.length;
  ...
  function indivSurrCity(i) {
    ...
    setTimeout(() => {
      ...
      for (
        var ii = 0;
        ii < locationConfig.eightCities.cities.length - 1;
        ii++
      ) {
        if (
          cityData.displayname ==
          locationConfig.eightCities.cities[ii].displayname
        ) {
  ...
  function autoAirports() {
    $.getJSON(
      "https://api.weather.com/v3/location/near?geocode=" +
        ...
        "," +
        locationConfig.mainCity.lon +
        "&product=airport&subproduct=major&format=json&apiKey=" +
        api_key,
      function (data) {
    ...
    setTimeout(() => {
      locationConfig.airport.airportsAmount =
        locationConfig.airport.airports.length;
  ...
  function indivAutoAirports(i) {
    ...
    $.getJSON(
      "https://api.weather.com/v3/location/point?iataCode=" +
        airportCityList.codes[i] +
        "&language=en-US&format=json&apiKey=" +
        api_key,
      function (data) {
  ...
  function manualIndivCities(i) {
    ...
    if (locationSettings.eightCities.cities[i].type == "postalKey") {
      if (
        !locationSettings.eightCities.cities[i].val.includes(":US") &&
        locationSettings.mainCity.val.toString().length >= 5
      ) {
        locationSettings.eightCities.cities[i].val =
          locationSettings.eightCities.cities[i].val + ":US";
      }
    }
    $.getJSON(
      "https://api.weather.com/v3/location/point?" +
        locationSettings.eightCities.cities[i].type +
        "=" +
        locationSettings.eightCities.cities[i].val +
        "&language=en-US&format=json&apiKey=" +
        api_key,
      function (data) {
        cityData.displayname =
          locationSettings.eightCities.cities[i].displayname != ""
            ? locationSettings.eightCities.cities[i].displayname
            : data.location.displayName;
        cityData.lat = data.location.latitude;
        cityData.lon = data.location.longitude;
  ...
  function manualIndivAirports(i) {
    ...
    if (locationSettings.airport.airports[i].type == "postalKey") {
      if (
        !locationSettings.airport.airports[i].val.includes(":US") &&
        locationSettings.mainCity.val.toString().length >= 5
      ) {
        locationSettings.airport.airports[i].val =
          locationSettings.airport.airports[i].val + ":US";
      }
    }
    $.getJSON(
      "https://api.weather.com/v3/location/point?iataCode=" +
        locationSettings.airport.airports[i].iataCode +
        "&language=en-US&format=json&apiKey=" +
        api_key,
      function (data) {
        airportData.displayname =
          locationSettings.airport.airports[i].displayname != ""
            ? locationSettings.airport.airports[i].displayname
            : data.location.airportName;
        airportData.lat = data.location.latitude;
        airportData.lon = data.location.longitude;
        airportData.iataCode = data.location.iataCode;
      }
  ...
  function autoGolfCourses() {
    $.getJSON(
      ...
      function (data) {
        ...
        setTimeout(() => {
          locationConfig.golf.coursesAmount =
            locationConfig.golf.courses.length;
  ...
  function autoIndivGolfCourse(i) {
    ...
    setTimeout(() => {
      ...
      for (var ii = 0; ii < locationConfig.golf.courses.length - 1; ii++) {
        if (
          courseData.displayname == locationConfig.golf.courses[ii].displayname
        ) {
  ...
  function manualIndivCourses(i) {
    ...
    if (locationSettings.golf.courses[i].type == "postalKey") {
      if (
        !locationSettings.golf.courses[i].val.includes(":US") &&
        locationSettings.mainCity.val.toString().length >= 5
      ) {
        locationSettings.golf.courses[i].val =
          locationSettings.golf.courses[i].val + ":US";
      }
    }
    $.getJSON(
      "https://api.weather.com/v3/location/point?" +
        locationSettings.golf.courses[i].type +
        "=" +
        locationSettings.golf.courses[i].val +
        "&language=en-US&format=json&apiKey=" +
        api_key,
      function (data) {
        courseData.displayname =
          locationSettings.golf.courses[i].displayname != ""
            ? locationSettings.golf.courses[i].displayname
            : data.location.displayName + " Golf Courses";
        courseData.lat = data.location.latitude;
        courseData.lon = data.location.longitude;
        courseData.state = data.location.adminDistrictCode;
        courseData.stateFull = data.location.adminDistrict;
  ...
  function autoGolfResorts() {
    $.getJSON(
      ...
      function (data) {
        ...
        setTimeout(() => {
          locationConfig.golf.resortsAmount =
            locationConfig.golf.resorts.length;
  ...
  function autoIndivGolfResorts(i) {
    ...
    setTimeout(() => {
      ...
      for (var ii = 0; ii < locationConfig.golf.resorts.length - 1; ii++) {
        if (
          resortData.displayname == locationConfig.golf.resorts[ii].displayname
        ) {
  ...
  function manualIndivResorts(i) {
    ...
    $.getJSON(
      "https://api.weather.com/v3/location/point?" +
        locationSettings.golf.resorts[i].type +
        "=" +
        locationSettings.golf.resorts[i].val +
        "&language=en-US&format=json&apiKey=" +
        api_key,
      function (data) {
        resortData.displayname =
          locationSettings.golf.resorts[i].displayname != ""
            ? locationSettings.golf.resorts[i].displayname + " Golf Resorts"
            : data.location.displayName;
        resortData.lat = data.location.latitude;
        resortData.lon = data.location.longitude;
        resortData.state = data.location.adminDistrictCode;
