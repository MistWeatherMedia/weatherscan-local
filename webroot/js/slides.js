...
var slidePrograms = {
  ...
  extraExtendedForecast() {
    ...
    try {
      ...
      for (var i = 0; i < 5; i++) {
        ...
        $(
          ".extra-extended-forecast .slide-data .day." + daysDivs[i] + " .high"
    ...
    try {
      ...
      $(".almanac-slide .slide-data .moonphase.one").css(
        ...
        'url("images/moonphases/' +
          weatherData.almanac.moonphases[0].moon +
          '.png")'
      );
      $(".almanac-slide .slide-data .moonphase.two").css(
        "background-image",
        'url("images/moonphases/' +
          weatherData.almanac.moonphases[1].moon +
          '.png")'
      );
      $(".almanac-slide .slide-data .moonphase.three").css(
        "background-image",
        'url("images/moonphases/' +
          weatherData.almanac.moonphases[2].moon +
          '.png")'
      );
      $(".almanac-slide .slide-data .moonphase.four").css(
        "background-image",
        'url("images/moonphases/' +
          weatherData.almanac.moonphases[3].moon +
          '.png")'
      );
      ...
      $(".almanac-slide .slide-data .phasedate.one").text(
        weatherData.almanac.moonphases[0].date
      );
      $(".almanac-slide .slide-data .phasedate.two").text(
        weatherData.almanac.moonphases[1].date
      );
      $(".almanac-slide .slide-data .phasedate.three").text(
        weatherData.almanac.moonphases[2].date
      );
      $(".almanac-slide .slide-data .phasedate.four").text(
        weatherData.almanac.moonphases[3].date
      );
    ...
    try {
      for (var i = 0; i < 4; i++) {
        try {
          ...
          getIcon(
            $(
              ".nearby-cities.one .slide-data .city." + citiesDivs[i] + " .icon"
            ),
        ...
        try {
          ...
          getIcon(
            $(
              ".nearby-cities.two .slide-data .city." + citiesDivs[i] + " .icon"
            ),
  ...
  providerSlide() {
    $(".provider-slide .provider-text").text(
      apperanceSettings.providerName +
        "\n" +
  ...
  ESextendedForecast() {
    ...
    try {
      ...
      for (var i = 0; i < 5; i++) {
        ...
        $(
          ".spanish-extended-forecast .slide-data .day." + daysDivs[i] + " .low"
  ...
  courseForecast() {
    ...
    try {
      for (var ii = 0; ii < locationConfig.golf.coursesAmount; ii++) {
        $(".course-forecast." + slideNames[ii] + " .slide-data .cityname").text(
          weatherData.golf.courseForecast[ii].cityname
        );
        for (var i = 0; i < 5; i++) {
          $(
            ".course-forecast." +
      ...
      for (var i = 0; i < 3; i++) {
        if (weatherData.uvIndex.forecast[i].uv != "noreport") {
          $(".uv-index .slide-data " + barlabels[i] + ".uvbar .bar").css(
            "height",
            barheights[weatherData.uvIndex.forecast[i].uv] + "px"
          );
          $(".uv-index .slide-data " + barlabels[i] + ".uvbar .uvindex").css(
            "margin-bottom",
            labelmargins[weatherData.uvIndex.forecast[i].uv] + "px"
          );
          ...
          $(".uv-index .slide-data " + barlabels[i] + ".uvbar .uvdesc").text(
            bardescs[weatherData.uvIndex.forecast[i].uv]
          );
