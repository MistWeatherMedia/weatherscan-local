    ...
    dopplerRadar() {
      try {
        ...
        if (apperanceSettings.aspectRatio == 3/2) {
          ...
          $("#locradar").attr("style","transform: scale(1.13, 1.335) translate3d(0,0,0);");
          setTimeout(() => {
            //$('#locradar .mapboxgl-canvas-container .mapboxgl-canvas').attr("width", "1440")
            //$('#locradar .mapboxgl-canvas-container .mapboxgl-canvas').attr("height", "1080")
            //$('#locradar .mapboxgl-canvas-container .mapboxgl-canvas').attr("style", "width: 1439.86px; height: 1080px;")
            //$('#locradar .mapboxgl-canvas-container .mapboxgl-canvas').attr("style", "width: 1439.86px;")
            //console.log(locradar)
          }, 500);
        }
        setTimeout(function () {
          slideCallBack();
