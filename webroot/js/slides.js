...
var slidePrograms = {
  ...
  extraCurrentConditions: {
    ...
    func: function () {
      try {
        $(".extra-current-conditions .slide-data .cityname").text(
          weatherData.extraLocal.currentConditions.cityname
        );
  ...
  extraDayDesc: {
    ...
    func: function () {
      try {
        $(".extra-daydesc-forecast .cityname").text(
          weatherData.extraLocal.dayDesc.cityname
        );
        $(".extra-daydesc-forecast.one .slide-data .daytitle").text(
          weatherData.extraLocal.dayDesc.times[0].timetitle
        );
        $(".extra-daydesc-forecast.one .slide-data .daydesc").text(
          weatherData.extraLocal.dayDesc.times[0].forecast
        );
        $(".extra-daydesc-forecast.two .slide-data .daytitle").text(
          weatherData.extraLocal.dayDesc.times[1].timetitle
        );
        $(".extra-daydesc-forecast.two .slide-data .daydesc").text(
          weatherData.extraLocal.dayDesc.times[1].forecast
        );
        $(".extra-daydesc-forecast.three .slide-data .daytitle").text(
          weatherData.extraLocal.dayDesc.times[2].timetitle
        );
        $(".extra-daydesc-forecast.three .slide-data .daydesc").text(
          weatherData.extraLocal.dayDesc.times[2].forecast
        );
    ...
    func: function () {
      ...
      try {
        $(".extra-extended-forecast .slide-data .cityname").text(
          weatherData.extraLocal.extendedForecast.cityname
        );
        for (var i = 0; i < 5; i++) {
          $(
            ".extra-extended-forecast .slide-data .day." +
              daysDivs[i] +
              " .dayname"
          ).text(weatherData.extraLocal.extendedForecast.days[i].dayname);
          getIcon(
            $(
              ".extra-extended-forecast .slide-data .day." +
                daysDivs[i] +
          ...
          $(
            ".extra-extended-forecast .slide-data .day." +
              daysDivs[i] +
              " .condition"
          ).text(weatherData.extraLocal.extendedForecast.days[i].cond);
          $(
            ".extra-extended-forecast .slide-data .day." +
              daysDivs[i] +
              " .high"
          ).text(weatherData.extraLocal.extendedForecast.days[i].high);
          ...
          $(
            ".extra-extended-forecast .slide-data .day." + daysDivs[i] + " .low"
          ).text(weatherData.extraLocal.extendedForecast.days[i].low);
        }
  ...
  bulletin: {
    ...
    func: function () {
      try {
        if (weatherData.alerts.alertsAmount > 0) {
          $(".bulletin-slide .slide-data .cityname").text(
            locationConfig.mainCity.displayname + " Area"
          );
          ...
          for (var i = 0; i < weatherData.alerts.alertsAmount; i++) {
            ...
            $(".bulletin-slide .slide-data .alerts").text(
              prevtext + weatherData.alerts.warnings[i].headline + "\n"
            );
          }
    ...
    currentConditions() {
      try {
        $(".current-conditions .slide-data .cityname").text(
          weatherData.currentConditions.cityname
        );
    ...
    func: function () {
      ...
      try {
        $(".extended-forecast .slide-data .cityname").text(
          weatherData.extendedForecast.cityname
        );
        for (var i = 0; i < 5; i++) {
          $(
            ".extended-forecast .slide-data .day." + daysDivs[i] + " .dayname"
          ).text(weatherData.extendedForecast.days[i].dayname);
          getIcon(
            $(".extended-forecast .slide-data .day." + daysDivs[i] + " .icon"),
            weatherData.extendedForecast.days[i].icon,
            weatherData.extendedForecast.days[i].windspeed
          );
          $(
            ".extended-forecast .slide-data .day." + daysDivs[i] + " .condition"
          ).text(weatherData.extendedForecast.days[i].cond);
          $(
            ".extended-forecast .slide-data .day." + daysDivs[i] + " .high"
          ).text(weatherData.extendedForecast.days[i].high);
          if (weatherData.extendedForecast.noReport == true) {
            $(
              ".extended-forecast .slide-data .day." + daysDivs[i] + " .divider"
            ).text("");
          } else {
            $(
              ".extended-forecast .slide-data .day." + daysDivs[i] + " .divider"
          ...
          $(
            ".extended-forecast .slide-data .day." + daysDivs[i] + " .low"
          ).text(weatherData.extendedForecast.days[i].low);
        }
    ...
    func: function () {
      try {
        $(".almanac-slide .slide-data .dayname-today").text(
          weatherData.almanac.time.today
        );
        $(".almanac-slide .slide-data .dayname-tomorrow").text(
          weatherData.almanac.time.tomorrow
        );
        $(".almanac-slide .slide-data .sunrise-today").text(
          weatherData.almanac.time.sunrisetoday
        );
        $(".almanac-slide .slide-data .sunset-today").text(
          weatherData.almanac.time.sunsettoday
        );
        $(".almanac-slide .slide-data .sunrise-tomorrow").text(
          weatherData.almanac.time.sunrisetomorow
        );
        $(".almanac-slide .slide-data .sunset-tomorrow").text(
          weatherData.almanac.time.sunsettomorrow
        );
        $(".almanac-slide .slide-data .moonphase.one").css(
          "background-image",
          'url("images/moonphases/' +
            weatherData.almanac.moonphases.moons[0].moon +
            '.png")'
        );
        $(".almanac-slide .slide-data .moonphase.two").css(
          "background-image",
          'url("images/moonphases/' +
            weatherData.almanac.moonphases.moons[1].moon +
            '.png")'
        );
        $(".almanac-slide .slide-data .moonphase.three").css(
          "background-image",
          'url("images/moonphases/' +
            weatherData.almanac.moonphases.moons[2].moon +
            '.png")'
        );
        $(".almanac-slide .slide-data .moonphase.four").css(
          "background-image",
          'url("images/moonphases/' +
            weatherData.almanac.moonphases.moons[3].moon +
            '.png")'
        );
        ...
        $(".almanac-slide .slide-data .phasedate.one").text(
          weatherData.almanac.moonphases.moons[0].date
        );
        $(".almanac-slide .slide-data .phasedate.two").text(
          weatherData.almanac.moonphases.moons[1].date
        );
        $(".almanac-slide .slide-data .phasedate.three").text(
          weatherData.almanac.moonphases.moons[2].date
        );
        $(".almanac-slide .slide-data .phasedate.four").text(
          weatherData.almanac.moonphases.moons[3].date
        );
        ...
        $(".almanac-slide .slide-data .moonphase.one").css(
          "background-image",
          'url("images/moonphases/blank.png")'
        );
        $(".almanac-slide .slide-data .moonphase.two").css(
          "background-image",
          'url("images/moonphases/blank.png")'
  ...
  dayDesc: {
    ...
    func: function () {
      try {
        ...
        $(".daydesc-forecast .cityname").text(
          locationConfig.mainCity.displayname
        );
        $(".daydesc-forecast.one .slide-data .daytitle").text("");
        $(".daydesc-forecast.one .slide-data .daydesc").text("");
    ...
    func: function () {
      ...
      try {
        for (var i = 0; i < 4; i++) {
          try {
            $(
              ".nearby-cities.one .slide-data .city." +
                citiesDivs[i] +
                " .cityname"
            ).text(weatherData.nearbyCities.cities[i].cityname);
            $(
              ".nearby-cities.one .slide-data .city." +
                citiesDivs[i] +
                " .temperature"
            ).text(weatherData.nearbyCities.cities[i].temp);
            getIcon(
              $(
                ".nearby-cities.one .slide-data .city." +
                  citiesDivs[i] +
              ...
              weatherData.nearbyCities.cities[i].icon,
              weatherData.nearbyCities.cities[i].windspeed
            );
            $(
              ".nearby-cities.one .slide-data .city." + citiesDivs[i] + " .wind"
            ).text(weatherData.nearbyCities.cities[i].wind);
          } catch (error) {
            $(
              ".nearby-cities.one .slide-data .city." +
                citiesDivs[i] +
          ...
          try {
            $(
              ".nearby-cities.two .slide-data .city." +
                citiesDivs[i] +
                " .cityname"
            ).text(weatherData.nearbyCities.cities[i + 4].cityname);
            $(
              ".nearby-cities.two .slide-data .city." +
                citiesDivs[i] +
                " .temperature"
            ).text(weatherData.nearbyCities.cities[i + 4].temp);
            getIcon(
              $(
                ".nearby-cities.two .slide-data .city." +
                  citiesDivs[i] +
              ...
              weatherData.nearbyCities.cities[i + 4].icon,
              weatherData.nearbyCities.cities[i + 4].windspeed
            );
            $(
              ".nearby-cities.two .slide-data .city." + citiesDivs[i] + " .wind"
            ).text(weatherData.nearbyCities.cities[i + 4].wind);
          } catch (error) {
            $(
              ".nearby-cities.two .slide-data .city." +
                citiesDivs[i] +
          ...
          try {
            $(
              ".nearby-cities.two .slide-data .city." +
                citiesDivs[i] +
                " .cityname"
            ).text(locationConfig.eightCities.cities[i + 4].displayname);
            getIcon(
              $(
                ".nearby-cities.two .slide-data .city." +
                  citiesDivs[i] +
  ...
  providerSlide: {
    data: [],
    func: function () {
      $(".provider-slide .provider-text").text(
  ...
  upNext: {
    ...
    func: function () {
      ...
      for (var i = 0; i < slideSettings.order[0].slideLineup.length; i++) {
        if (
          slideTitles[slideSettings.order[0].slideLineup[i].group] == "intro" ||
          slideTitles[slideSettings.order[0].slideLineup[i].group] == undefined
        ) {
          marginval -= 85;
          continue;
        } else {
          if (i == gidx) {
            $(".upnext-slide .next").append(
              `<span class="upnext-list current">${
                slideTitles[slideSettings.order[0].slideLineup[i].group]
              }</span>\n`
            );
          } else {
            $(".upnext-slide .next").append(
              `<span class="upnext-list">${
                slideTitles[slideSettings.order[0].slideLineup[i].group]
              }</span>\n`
            );
          }
    ...
    func: function () {
      try {
        try {
          ...
          $(".airport-conditions.one .slide-data .delay").text(
            weatherData.airportConditions.airports[0].delay
          );
          $(".airport-conditions.one .slide-data .humidity").text(
            weatherData.airportConditions.airports[0].humidity
          );
          $(".airport-conditions.one .slide-data .pressure").text(
            weatherData.airportConditions.airports[0].pressure
          );
          $(".airport-conditions.one .slide-data .wind").text(
            weatherData.airportConditions.airports[0].wind
          );
          $(".airport-conditions.one .slide-data .gusts").text(
            weatherData.airportConditions.airports[0].gusts
          );
          getIcon(
            $(".airport-conditions.one .slide-data .icon"),
            weatherData.airportConditions.airports[0].icon,
            weatherData.airportConditions.airports[0].windpseed
          );
          $(".airport-conditions.one .slide-data .condition").text(
            weatherData.airportConditions.airports[0].condition
          );
          $(".airport-conditions.one .slide-data .temperature").text(
            weatherData.airportConditions.airports[0].temp
          );
        } catch (error) {
          try {
            $(".airport-conditions.one .slide-data .airportname").text(
        ...
        try {
          $(".airport-conditions.two .slide-data .airportname").text(
            weatherData.airportConditions.airports[1].airportName
          );
          $(".airport-conditions.two .slide-data .delay").text(
            weatherData.airportConditions.airports[1].delay
          );
          $(".airport-conditions.two .slide-data .humidity").text(
            weatherData.airportConditions.airports[1].humidity
          );
          $(".airport-conditions.two .slide-data .pressure").text(
            weatherData.airportConditions.airports[1].pressure
          );
          $(".airport-conditions.two .slide-data .wind").text(
            weatherData.airportConditions.airports[1].wind
          );
          $(".airport-conditions.two .slide-data .gusts").text(
            weatherData.airportConditions.airports[1].gusts
          );
          getIcon(
            $(".airport-conditions.two .slide-data .icon"),
            weatherData.airportConditions.airports[1].icon,
            weatherData.airportConditions.airports[0].windpseed
          );
          $(".airport-conditions.two .slide-data .condition").text(
            weatherData.airportConditions.airports[1].condition
          );
          $(".airport-conditions.two .slide-data .temperature").text(
            weatherData.airportConditions.airports[1].temp
          );
        } catch (error) {
          try {
            $(".airport-conditions.two .slide-data .airportname").text(
    ...
    func: function () {
      ...
      try {
        for (var i = 0; i < 4; i++) {
          try {
            $(
              ".national-airports.one .slide-data .airport." +
                citiesDivs[i] +
                " .airportname"
            ).text(weatherData.nationalAirports.airports[i].airportname);
            $(
              ".national-airports.one .slide-data .airport." +
                citiesDivs[i] +
                " .temperature"
            ).text(weatherData.nationalAirports.airports[i].temp);
            getIcon(
              $(
                ".national-airports.one .slide-data .airport." +
                  citiesDivs[i] +
              ...
              weatherData.nationalAirports.airports[i].icon,
            ...
            $(
              ".national-airports.one .slide-data .airport." +
                citiesDivs[i] +
                " .delay"
            ).text(weatherData.nationalAirports.airports[i].delay);
          } catch (error) {
            $(
              ".national-airports.one .slide-data .airport." +
                citiesDivs[i] +
          ...
          try {
            $(
              ".national-airports.two .slide-data .airport." +
                citiesDivs[i] +
                " .airportname"
            ).text(weatherData.nationalAirports.airports[i + 4].airportname);
            $(
              ".national-airports.two .slide-data .airport." +
                citiesDivs[i] +
                " .temperature"
            ).text(weatherData.nationalAirports.airports[i + 4].temp);
            getIcon(
              $(
                ".national-airports.two .slide-data .airport." +
                  citiesDivs[i] +
              ...
              weatherData.nationalAirports.airports[i + 4].icon,
              weatherData.nationalAirports.airports[i + 4].windspeed
            );
            $(
              ".national-airports.two .slide-data .airport." +
                citiesDivs[i] +
                " .delay"
            ).text(weatherData.nationalAirports.airports[i + 4].delay);
          } catch (error) {
            $(
              ".national-airports.two .slide-data .airport." +
                citiesDivs[i] +
  ...
  EScurrentConditions: {
    ...
    func: function () {
      try {
        $(".spanish-current-conditions .slide-data .cityname").text(
          weatherData.spanish.currentConditions.cityname
        );
        ...
        getIcon(
          ...
          weatherData.spanish.currentConditions.icon,
    ...
    func: function () {
      ...
      try {
        $(".spanish-extended-forecast .slide-data .cityname").text(
          weatherData.spanish.extendedForecast.cityname
        );
        for (var i = 0; i < 5; i++) {
          $(
          ...
          $(
            ".spanish-extended-forecast .slide-data .day." +
              daysDivs[i] +
              " .condition"
          ).text(weatherData.spanish.extendedForecast.days[i].cond);
          $(
            ".spanish-extended-forecast .slide-data .day." +
              daysDivs[i] +
              " .high"
          ).text(weatherData.spanish.extendedForecast.days[i].high);
          ...
          $(
            ".spanish-extended-forecast .slide-data .day." +
              daysDivs[i] +
              " .low"
          ).text(weatherData.spanish.extendedForecast.days[i].low);
        }
  ...
  ESalmanac: {
    ...
    func: function () {
      try {
        ...
        $(".spanish-almanac-slide .slide-data .moonphase.one").css(
          "background-image",
          'url("images/moonphases/' +
            weatherData.spanish.almanac.moonphases[0].moon +
            '.png")'
        );
        $(".spanish-almanac-slide .slide-data .moonphase.two").css(
          "background-image",
          'url("images/moonphases/' +
            weatherData.spanish.almanac.moonphases[1].moon +
            '.png")'
        );
        $(".spanish-almanac-slide .slide-data .moonphase.three").css(
          "background-image",
          'url("images/moonphases/' +
            weatherData.spanish.almanac.moonphases[2].moon +
            '.png")'
        );
        $(".spanish-almanac-slide .slide-data .moonphase.four").css(
          "background-image",
          'url("images/moonphases/' +
            weatherData.spanish.almanac.moonphases[3].moon +
            '.png")'
        );
        ...
        $(".spanish-almanac-slide .slide-data .phasedate.one").text(
          weatherData.spanish.almanac.moonphases[0].date
        );
        $(".spanish-almanac-slide .slide-data .phasedate.two").text(
          weatherData.spanish.almanac.moonphases[1].date
        );
        $(".spanish-almanac-slide .slide-data .phasedate.three").text(
          weatherData.spanish.almanac.moonphases[2].date
        );
        $(".spanish-almanac-slide .slide-data .phasedate.four").text(
          weatherData.spanish.almanac.moonphases[3].date
        );
    ...
    func: function () {
      ...
      try {
        for (var i = 0; i < 4; i++) {
          try {
            $(
              ".spanish-nearby-cities.one .slide-data .city." +
                citiesDivs[i] +
                " .cityname"
            ).text(weatherData.spanish.nearbyCities.cities[i].cityname);
            $(
              ".spanish-nearby-cities.one .slide-data .city." +
                citiesDivs[i] +
                " .temperature"
            ).text(weatherData.spanish.nearbyCities.cities[i].temp);
            getIcon(
              $(
                ".spanish-nearby-cities.one .slide-data .city." +
                  citiesDivs[i] +
              ...
              weatherData.spanish.nearbyCities.cities[i].icon,
              weatherData.nearbyCities.cities[i].windspeed
            );
            $(
              ".spanish-nearby-cities.one .slide-data .city." +
                citiesDivs[i] +
                " .wind"
            ).text(weatherData.spanish.nearbyCities.cities[i].wind);
          } catch (error) {
            $(
              ".spanish-nearby-cities.one .slide-data .city." +
                citiesDivs[i] +
          ...
          try {
            $(
              ".spanish-nearby-cities.two .slide-data .city." +
                citiesDivs[i] +
                " .cityname"
            ).text(weatherData.spanish.nearbyCities.cities[i + 4].cityname);
            $(
              ".spanish-nearby-cities.two .slide-data .city." +
                citiesDivs[i] +
                " .temperature"
            ).text(weatherData.spanish.nearbyCities.cities[i + 4].temp);
            getIcon(
              $(
                ".spanish-nearby-cities.two .slide-data .city." +
                  citiesDivs[i] +
              ...
              weatherData.spanish.nearbyCities.cities[i + 4].icon,
              weatherData.nearbyCities.cities[i + 4].windspeed
            );
            $(
              ".spanish-nearby-cities.two .slide-data .city." +
                citiesDivs[i] +
                " .wind"
            ).text(weatherData.spanish.nearbyCities.cities[i + 4].wind);
          } catch (error) {
            $(
              ".spanish-nearby-cities.two .slide-data .city." +
                citiesDivs[i] +
    ...
    func: function () {
      ...
      try {
        for (var ii = 0; ii < locationConfig.golf.coursesAmount; ii++) {
          $(
            ".course-forecast." + slideNames[ii] + " .slide-data .cityname"
          ).text(weatherData.golf.courseForecast[ii].cityname);
          for (var i = 0; i < 5; i++) {
            $(
              ".course-forecast." +
                slideNames[ii] +
                ...
                daysDivs[i] +
                " .dayname"
            ).text(weatherData.golf.courseForecast[ii].days[i].dayname);
            getIcon(
              $(
                ".course-forecast." +
                  slideNames[ii] +
              ...
              weatherData.golf.courseForecast[ii].days[i].icon,
              weatherData.golf.courseForecast[0].days[i].windspeed
            );
            $(
              ".course-forecast." +
                slideNames[ii] +
                ...
                daysDivs[i] +
                " .condition"
            ).text(weatherData.golf.courseForecast[ii].days[i].cond);
            $(
              ".course-forecast." +
                slideNames[ii] +
                " .slide-data .day." +
                daysDivs[i] +
                " .high"
            ).text(weatherData.golf.courseForecast[ii].days[i].high);
            ...
            $(
              ".course-forecast." +
                ...
                daysDivs[i] +
                " .low"
            ).text(weatherData.golf.courseForecast[ii].days[i].low);
          }
        }
  ...
  uvIndex: {
    data: ["healthCur", "health24hr"],
    func: function () {
      $(".uv-index .slide-data .cityname").text(
        weatherData.uvIndex.current.cityname
      );
      ...
      try {
        if (weatherData.uvIndex.current.uv != "noreport") {
          $(".uv-index .slide-data .current.uvbar .bar").css(
            "height",
            barheights[weatherData.uvIndex.current.uv] + "px"
          );
          $(".uv-index .slide-data .current.uvbar .uvindex").css(
            "margin-bottom",
            labelmargins[weatherData.uvIndex.current.uv] + "px"
          );
          $(".uv-index .slide-data .current.uvbar .uvdesc").css(
            "margin-bottom",
            labelmargins[weatherData.uvIndex.current.uv] + "px"
          );
          $(".uv-index .slide-data .current.uvbar .uvindex").text(
            weatherData.uvIndex.current.uv
          );
          $(".uv-index .slide-data .current.uvbar .uvdesc").text(
            bardescs[weatherData.uvIndex.current.uv]
          );
        ...
        for (var i = 0; i < 3; i++) {
          if (weatherData.uvIndex.forecast.days[i].uv != "noreport") {
            $(".uv-index .slide-data " + barlabels[i] + ".uvbar .bar").css(
              "height",
              barheights[weatherData.uvIndex.forecast.days[i].uv] + "px"
            );
            $(".uv-index .slide-data " + barlabels[i] + ".uvbar .uvindex").css(
              "margin-bottom",
              labelmargins[weatherData.uvIndex.forecast.days[i].uv] + "px"
            );
            $(".uv-index .slide-data " + barlabels[i] + ".uvbar .uvdesc").css(
              "margin-bottom",
              labelmargins[weatherData.uvIndex.forecast.days[i].uv] + "px"
            );
            $(".uv-index .slide-data " + barlabels[i] + ".uvbar .uvindex").text(
              weatherData.uvIndex.forecast[i].uv
            );
            $(".uv-index .slide-data " + barlabels[i] + ".uvbar .uvdesc").text(
              bardescs[weatherData.uvIndex.forecast.days[i].uv]
            );
            $(".uv-index .slide-data " + barlabels[i] + ".uvbar .label").text(
              weatherData.uvIndex.forecast.days[i].time +
                "\n" +
                weatherData.uvIndex.forecast.days[i].day
            );
          } else {
            $(".uv-index .slide-data " + barlabels[i] + ".uvbar .bar").css(
              "height",
